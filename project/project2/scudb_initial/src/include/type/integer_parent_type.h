...
public:
  ...
  virtual Value Subtract(const Value &left,
                         const Value &right) const override = 0;
  virtual Value Multiply(const Value &left,
                         const Value &right) const override = 0;
  virtual Value Divide(const Value &left,
                       const Value &right) const override = 0;
  virtual Value Modulo(const Value &left,
                       const Value &right) const override = 0;
  ...
  virtual CmpBool CompareEquals(const Value &left,
                                const Value &right) const override = 0;
  virtual CmpBool CompareNotEquals(const Value &left,
                                   const Value &right) const override = 0;
  virtual CmpBool CompareLessThan(const Value &left,
                                  const Value &right) const override = 0;
  ...
  virtual CmpBool CompareGreaterThan(const Value &left,
                                     const Value &right) const override = 0;
  virtual CmpBool
  CompareGreaterThanEquals(const Value &left,
                           const Value &right) const override = 0;

  virtual Value CastAs(const Value &val,
                       const TypeId type_id) const override = 0;
  ...
  virtual void SerializeTo(const Value &val, char *storage) const override = 0;

  // Deserialize a value of the given type from the given storage space.
  virtual Value DeserializeFrom(const char *storage) const override = 0;
...
protected:
  ...
  virtual Value OperateNull(const Value &left,
                            const Value &right) const override = 0;
